...
python tests/system_tests/compare_tables.py example/iPRG2016.proteins.1vs2.tsv example/iPRG2016_ref.proteins.1vs2.tsv
if [[ $? -eq 0 ]]; then
...
python tests/system_tests/compare_tables.py example/iPRG2016.proteins.1vs3.tsv example/iPRG2016_ref.proteins.1vs3.tsv
if [[ $? -eq 0 ]]; then
...
python tests/system_tests/compare_tables.py example/iPRG2016.proteins.2vs3.tsv example/iPRG2016_ref.proteins.2vs3.tsv
if [[ $? -eq 0 ]]; then
